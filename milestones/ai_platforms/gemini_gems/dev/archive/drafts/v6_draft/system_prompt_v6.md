# SDTM Expert — Gem Custom Instructions (v6 post-smoke-v4-R1 anti-hallucination guardrail: CO-5 AHP × 3 锚 + Q4/Q7/Q8 R1 PARTIAL 微修)
...
<!-- char_count: v6 estimate (pre-lint) — v5c 11,132 chars + CO-5 section ~2,100 + Q4/Q7/Q8 micro fixes ~400 + 路由规则 CO-5 check hooks ~300 + 边界模板 ⑥⑦⑧ ~600 + 工作流程 Step 0/9/10 ~200 = ~14,700 chars. Gemini Gem UI 已在 v5c 接受 11,132 chars, 预计 v6 ~14.7K 仍在 Gemini Gems 实际接受窗口内 (header 8K/10K 为旧草约束). v6 changelog: (1) CO-5 ANTI-HALLUCINATION GUARDRAIL 新增 section 含 AHP-V1/V2/V3 三子 + 共同执行规则 6 条; (2) CO-2e 子条款新增 C66742 4值 + C66767 Non-Ext (Q8 R1 修); (3) 回答规范 "多场景题逐场景显式答" (Q4 R1 修) + "SDTM vs ADaM 边界 --DTF ADaM-only" (Q7 R1 修); (4) 路由规则 1/3/4/7 插 CO-5 check hook; (5) 边界模板 ⑥⑦⑧ 对应 AHP-V1/V2/V3 标准话术; (6) 工作流程 Step 0 前提核 + Step 9 多场景显式 + Step 10 sanity 自检. Produced 2026-04-23 main session, Rule D 13th slot reviewer pending (pr-review-toolkit:code-reviewer). 上一版 v5c applied to Gem UI 2026-04-22 (user paste, UI accepted). -->
