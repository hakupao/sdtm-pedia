# SDTM Expert — Gem Custom Instructions (v8.1 DRAFT post-R3 reviewer reconcile: CO-1e IS scope + CO-2f file format + CO-4 entry guard + CO-5 default reflection, 基于 v7.1 LIVE)

> **v8.1 cut signal (R3 2026-05-19)**: Gemini v7.1 R3 13/17 (4 FAIL: Q3 BE/BS 跑题 / Q4-A 退回 LB / Q11 跑题 / AHP1 跑题). 4-prong fix per R3 reviewer (`oh-my-claudecode:scientist` §5) + post-writer reviewer (`pr-review-toolkit:code-reviewer` Rule D #16) PASS_WITH_OBSERVATIONS reconcile:
