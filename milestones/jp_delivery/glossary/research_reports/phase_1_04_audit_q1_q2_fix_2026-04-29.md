...
対象ファイル:
- `branches/jp_delivery/scripts/audit_terms.py`
- `branches/jp_delivery/glossary/term_mapping.yml`
- `branches/jp_delivery/glossary/term_blacklist.yml`
...
- **リポジトリルート判定**: `branches/jp_delivery/glossary/term_blacklist.yml` から親 4 階層 (glossary → jp → docs → repo_root) で動的解決. ハードコードは不使用.
- **glob 照合二段戦略**:
...
```
コマンド: python3 branches/jp_delivery/scripts/audit_terms.py branches/jp_delivery/99_用語集.xlsx
...
input_relative_path: branches/jp_delivery/99_用語集.xlsx
EXIT_CODE: 0
```
...
```
コマンド: python3 branches/jp_delivery/scripts/audit_terms.py branches/jp_delivery/templates/sample_demo.xlsx
         --blacklist branches/jp_delivery/glossary/term_blacklist.yml
         --mapping branches/jp_delivery/glossary/term_mapping.yml --check-consistency
```
...
コマンド: python3 branches/jp_delivery/scripts/audit_terms.py /tmp/test_fail.xlsx
         --blacklist branches/jp_delivery/glossary/term_blacklist.yml
         --mapping branches/jp_delivery/glossary/term_mapping.yml --check-consistency
```
...
`branches/jp_delivery/templates/sample_demo.xlsx` の 1_表紙 B7 に「作成者」が残存。
