<!-- chain: F (深度验证旁枝链 v2)
  ...
  → ../../.work/03_verification/issues_found.md   (问题回流, 继续编号 Issue 5+)
  → ../../.work/meta/worklog/phase06_deep_verification.md                   (工作日志)
-->
...
**文件**: `branches/06_deep_verification/intentional_exclude_whitelist.md` (工程启动时为空)
