...
2. `branches/06_deep_verification/subagent_prompts/P0_writer_pdf_v1.8.md`
3. `branches/06_deep_verification/subagent_prompts/P0_reviewer_v1.8.md`
4. `branches/06_deep_verification/multi_session/MULTI_SESSION_PROTOCOL.md`
5. `branches/06_deep_verification/multi_session/MULTI_SESSION_RETRO_ROUND_13.md` (round 13 batch 51 drift cal precedent for v1.7→v1.8 baseline transition)
6. `branches/06_deep_verification/evidence/checkpoints/drift_cal_batch_51_sv20_p045_report.md` (round 13 drift cal multi-axis bidirectional template)
