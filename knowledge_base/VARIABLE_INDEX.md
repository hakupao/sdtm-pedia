...
> Auto-generated — do not edit manually | Generated: 2026-08-07
...
| C66727 | 1 | DS.DSDECOD |
| C66728 | 26 | AE.AEENRF, AE.AEENRTPT, AG.AGENRF, AG.AGENRTPT, AG.AGSTRF, AG.AGSTRTPT, CE.CEENRF, CE.CEENRTPT, CE.CESTRF, CE.CESTRTPT, CM.CMENRF, CM.CMENRTPT, CM.CMSTRF, CM.CMSTRTPT, HO.HOENRTPT, HO.HOSTRTPT, MH.MHENRF, MH.MHENRTPT, PR.PRENRTPT, PR.PRSTRTPT, RS.RSENRTPT, RS.RSSTRTPT, SU.SUENRF, SU.SUENRTPT, SU.SUSTRF, SU.SUSTRTPT |
...
| C66742 | 123 | AE.AECONTRT, AE.AEPRESP, AE.AESCAN, AE.AESCONG, AE.AESDISAB, AE.AESDTH, AE.AESER, AE.AESHOSP, AE.AESINTV, AE.AESLIFE, AE.AESMIE, AE.AESOD, AE.AEUNANT, AG.AGOCCUR, AG.AGPRESP, BS.BSBLFL, CE.CEOCCUR, CE.CEPRESP, CM.CMOCCUR, CM.CMPRESP, CP.CPBLFL, CP.CPCLSIG, CP.CPDRVFL, CP.CPLOBXFL, CV.CVBLFL, CV.CVDRVFL, CV.CVLOBXFL, DM.DTHFL, EC.ECFAST, EC.ECOCCUR, EC.ECPRESP, EG.EGBLFL, EG.EGCLSIG, EG.EGDRVFL, EG.EGLOBXFL, EX.EXFAST, FA.FABLFL, FA.FALOBXFL, FT.FTBLFL, FT.FTDRVFL, FT.FTLOBXFL, GF.GFBLFL, GF.GFDRVFL, HO.HOOCCUR, HO.HOPRESP, IE.IEORRES, IE.IESTRESC, IS.ISBLFL, IS.ISDRVFL, IS.ISLOBXFL, IS.ISSPCUFL, LB.LBBLFL, LB.LBCLSIG, LB.LBDRVFL, LB.LBFAST, LB.LBLOBXFL, LB.LBPTFL, LB.LBSPCUFL, MB.MBBLFL, MB.MBDRVFL, MB.MBFAST, MB.MBLOBXFL, MH.MHOCCUR, MH.MHPRESP, MI.MIBLFL, MI.MILOBXFL, MK.MKBLFL, MK.MKDRVFL, MK.MKLOBXFL, ML.MLOCCUR, ML.MLPRESP, MS.MSACPTFL, MS.MSBLFL, MS.MSDRVFL, MS.MSFAST, MS.MSLOBXFL, NV.NVBLFL, NV.NVDRVFL, NV.NVLOBXFL, OE.OEACPTFL, OE.OEBLFL, OE.OEDRVFL, OE.OELOBXFL, PC.PCDRVFL, PC.PCFAST, PE.PEBLFL, PE.PELOBXFL, PR.PROCCUR, PR.PRPRESP, QS.QSBLFL, QS.QSDRVFL, QS.QSLOBXFL, RE.REBLFL, RE.REDRVFL, RE.RELOBXFL, RP.RPBLFL, RP.RPDRVFL, RP.RPLOBXFL, RS.RSACPTFL, RS.RSBLFL, RS.RSDRVFL, RS.RSLOBXFL, SR.SRBLFL, SR.SRLOBXFL, SU.SUOCCUR, SU.SUPRESP, SV.SVEPCHGI, SV.SVOCCUR, SV.SVPRESP, TM.TMRPT, TR.TRACPTFL, TR.TRBLFL, TR.TRLOBXFL, TU.TUACPTFL, TU.TUBLFL, TU.TULOBXFL, UR.URBLFL, UR.URDRVFL, UR.URLOBXFL, VS.VSBLFL, VS.VSCLSIG, VS.VSDRVFL, VS.VSLOBXFL |
| C66767 | 1 | AE.AEACN |
| C66768 | 1 | AE.AEOUT |
| C66769 | 1 | AE.AESEV |
...
| C66789 | 36 | AG.AGSTAT, BS.BSSTAT, CE.CESTAT, CM.CMSTAT, CP.CPSTAT, CV.CVSTAT, DA.DASTAT, EG.EGSTAT, FA.FASTAT, FT.FTSTAT, GF.GFSTAT, HO.HOSTAT, IS.ISSTAT, LB.LBSTAT, MB.MBSTAT, MH.MHSTAT, MI.MISTAT, MK.MKSTAT, ML.MLSTAT, MS.MSSTAT, NV.NVSTAT, OE.OESTAT, PC.PCSTAT, PE.PESTAT, PP.PPSTAT, QS.QSSTAT, RE.RESTAT, RP.RPSTAT, RS.RSSTAT, SC.SCSTAT, SR.SRSTAT, SS.SSSTAT, SU.SUSTAT, TR.TRSTAT, UR.URSTAT, VS.VSSTAT |
| C66790 | 1 | DM.ETHNIC |
...
| C71620 | 58 | AG.AGDOSU, BS.BSORRESU, BS.BSSTRESU, CM.CMDOSU, CP.CPORRESU, CP.CPSTRESU, CV.CVORRESU, CV.CVSTRESU, DA.DAORRESU, DA.DASTRESU, EC.ECDOSU, EC.ECPSTRGU, EG.EGORRESU, EG.EGSTRESU, EX.EXDOSU, FA.FAORRESU, FA.FASTRESU, FT.FTORRESU, FT.FTSTRESU, GF.GFORRESU, GF.GFSTRESU, IS.ISORRESU, IS.ISSTRESU, LB.LBORRESU, LB.LBSTRESU, MB.MBORRESU, MB.MBSTRESU, MI.MIORRESU, MI.MISTRESU, MK.MKORRESU, MK.MKSTRESU, ML.MLDOSU, MS.MSCONCU, MS.MSORRESU, MS.MSSTRESU, NV.NVORRESU, NV.NVSTRESU, OE.OEORRESU, OE.OESTRESU, PE.PEORRESU, PR.PRDOSU, QS.QSORRESU, QS.QSSTRESU, RE.REORRESU, RE.RESTRESU, RP.RPORRESU, RP.RPSTRESU, RS.RSORRESU, RS.RSSTRESU, SC.SCORRESU, SC.SCSTRESU, SR.SRORRESU, SR.SRSTRESU, SU.SUDOSU, TR.TRORRESU, TR.TRSTRESU, UR.URORRESU, UR.URSTRESU |
| C74456 | 19 | AE.AELOC, BE.BELOC, CV.CVLOC, EC.ECLOC, EX.EXLOC, FA.FALOC, MB.MBLOC, MI.MILOC, MK.MKLOC, MS.MSLOC, NV.NVLOC, OE.OELOC, PE.PELOC, PR.PRLOC, RE.RELOC, SR.SRLOC, TU.TULOC, UR.URLOC, VS.VSLOC |
| C74457 | 1 | DM.RACE |
| C74558 | 1 | DS.DSCAT |
...
| C78735 | 19 | CO.COEVAL, CV.CVEVAL, DD.DDEVAL, EG.EGEVAL, FA.FAEVAL, MI.MIEVAL, MK.MKEVAL, MS.MSEVAL, NV.NVEVAL, OE.OEEVAL, PE.PEEVAL, RE.REEVAL, RS.RSEVAL, SR.SREVAL, SS.SSEVAL, SUPPQUAL.QEVAL, TR.TREVAL, TU.TUEVAL, UR.UREVAL |
| C78736 | 5 | CP.CPNRIND, IS.ISNRIND, LB.LBNRIND, MS.MSNRIND, OE.OENRIND |
| C78737 | 1 | RELREC.RELTYPE |
| C85491 | 1 | IS.ISBDAGNT |
| C85492 | 19 | BS.BSMETHOD, CP.CPMETHOD, CV.CVMETHOD, GF.GFMETHOD, IS.ISMETHOD, LB.LBMETHOD, MB.MBMETHOD, MI.MIMETHOD, MK.MKMETHOD, MS.MSMETHOD, NV.NVMETHOD, OE.OEMETHOD, PC.PCMETHOD, PE.PEMETHOD, RE.REMETHOD, SR.SRMETHOD, TR.TRMETHOD, TU.TUMETHOD, UR.URMETHOD |
| C85493 | 1 | PP.PPTEST |
...
| C99073 | 17 | CV.CVLAT, EC.ECLAT, EX.EXLAT, FA.FALAT, MB.MBLAT, MI.MILAT, MK.MKLAT, MS.MSLAT, NV.NVLAT, OE.OELAT, PE.PELAT, PR.PRLAT, RE.RELAT, SR.SRLAT, TU.TULAT, UR.URLAT, VS.VSLAT |
...
| C99079 | 44 | AE.EPOCH, AG.EPOCH, CE.EPOCH, CM.EPOCH, CP.EPOCH, CV.EPOCH, DA.EPOCH, DS.EPOCH, DV.EPOCH, EC.EPOCH, EG.EPOCH, EX.EPOCH, FA.EPOCH, FT.EPOCH, HO.EPOCH, IE.EPOCH, IS.EPOCH, LB.EPOCH, MB.EPOCH, MH.EPOCH, MI.EPOCH, MK.EPOCH, ML.EPOCH, MS.EPOCH, NV.EPOCH, OE.EPOCH, PC.EPOCH, PE.EPOCH, PP.EPOCH, PR.EPOCH, QS.EPOCH, RE.EPOCH, RP.EPOCH, RS.EPOCH, SC.EPOCH, SE.EPOCH, SR.EPOCH, SS.EPOCH, SU.EPOCH, TA.EPOCH, TR.EPOCH, TU.EPOCH, UR.EPOCH, VS.EPOCH |
