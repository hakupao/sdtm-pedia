...
The original publications are not redistributed in this repository; CDISC retains copyright. See [DISCLAIMER.md](DISCLAIMER.md).

## 2. Construction pipeline

The knowledge base was produced through a seven-phase pipeline. Each phase is documented as a separate work package — a phase plan, an execution log, and a verification record — held under [`.work/`](.work/) in the repository, which forms part of the auditable source rather than a separate documentation product.
...
In parallel with the seven-phase pipeline, an independent **atom-level literal verification audit** is being executed as a continuing work track. Each atomic claim in the knowledge base is reconciled against the source PDF on a page-by-page basis. As of 2026-04-29 the audit covers **97% of the in-scope pages** and remains active. Per-batch evidence is published under [`.work/06_deep_verification/evidence/checkpoints/`](.work/06_deep_verification/evidence/checkpoints).
...
The complete source-to-output mapping is published as the traceability matrix at [`docs/TRACEABILITY.md`](docs/TRACEABILITY.md).
...
Investigation record: [`.work/03_verification/issue1_investigation.md`](.work/03_verification/issue1_investigation.md).
...
Closure record: [`.work/03_verification/issues_found.md`](.work/03_verification/issues_found.md).
...
The four controls and their originating non-conformances are documented in full at [`.work/meta/retrospective.md`](.work/meta/retrospective.md).
...
**Repository:** https://github.com/hakupao/sdtm-pedia · **License:** CC BY 4.0 — see [LICENSE](LICENSE) and [DISCLAIMER.md](DISCLAIMER.md).
