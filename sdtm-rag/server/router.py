...
_DOSSIER_RULES = (
    ...
    "you know it, marked (推測); a variable missing from that block may simply not have been "
    "retrieved — do not claim the standard lacks it): list EVERY CT value as its own heading, in the standard's "
    ...
    "table columns, examples and illustrations — must be copied character for character from part B, with the form OID of "
    ...
    "as excluded with that domain instead; (4) name as target-domain variables only "
