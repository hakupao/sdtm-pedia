...
2026-09-15 用户裁定: **默认范围 s4-s12 + 一览含选择肢** (≈134K token cl100k_base 估计). 理由: 选择肢是判断字段归属的关键线索; 两档均 ≤ 150K. Task 4 默认白名单照此不变.

> 2026-09-25 补: Claude 原生实收 prompt 146.8K-155.5K (4/12 > 150K), 本文件数字为 cl100k 估计, 见 `dm2_dossier_e2e.md` §3 attempt 3。
