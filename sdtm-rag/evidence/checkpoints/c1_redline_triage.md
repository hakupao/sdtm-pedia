...
**✅ 2026-08-26 同日已处置**: 历史改写 + force push 完成 (`main` 876ce4b → 9a13dd2), 全部 7 个真实标识符 (含本节这 4 处) 在全历史与提交信息中归零, 详见 `history_purge_2026-08-26.md`。⚠ 仍做不到的: GitHub 侧孤儿对象需联系 Support purge / PR ref 永久保留 (本次已验证其内容干净) / 已有 clone 不受影响。

**⚠ 残留限制 (处置前的记录, 保留供追溯)**: 本次只清理了**当前 HEAD 的内容**。这 4 处真值仍存在于
