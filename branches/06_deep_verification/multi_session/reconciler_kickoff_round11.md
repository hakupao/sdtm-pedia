...
1. `branches/06_deep_verification/_progress.json` (recovery_hint + v1_7_cut_completed)
2. `branches/06_deep_verification/subagent_prompts/P0_writer_pdf_v1.7.md` (176 lines, v1.7 N21 + Hook 16.7)
3. `branches/06_deep_verification/subagent_prompts/P0_reviewer_v1.7.md` (137 lines, Rule D 56 → 59 expected post round 11)
4. `branches/06_deep_verification/multi_session/MULTI_SESSION_PROTOCOL.md` (master)
5. `branches/06_deep_verification/multi_session/MULTI_SESSION_RETRO_ROUND_10.md` (round 10 retro for context)
