...
- `branches/06_deep_verification/multi_session/batch_35_kickoff.md`
- `branches/06_deep_verification/multi_session/batch_36_kickoff.md`
- `branches/06_deep_verification/multi_session/batch_37_kickoff.md`
- `branches/06_deep_verification/multi_session/reconciler_kickoff_round8.md`
...
Files to PRESERVE:
- `branches/06_deep_verification/multi_session/MULTI_SESSION_PROTOCOL.md` (master guide)
- `branches/06_deep_verification/multi_session/MULTI_SESSION_RETRO.md` (round 1 retro)
- `branches/06_deep_verification/multi_session/MULTI_SESSION_RETRO_ROUND_2..8.md` (8 cumulative retros)
- `branches/06_deep_verification/multi_session/sibling_continuity_sweep_report*.md` (8 cumulative sweep reports)
- `branches/06_deep_verification/evidence/checkpoints/halt_state_batch_32.md` (round 7 1st LIVE-FIRE historical evidence)
- `branches/06_deep_verification/evidence/checkpoints/halt_state_batch_36.md` (round 8 2nd LIVE-FIRE historical evidence per D-MS-8)
