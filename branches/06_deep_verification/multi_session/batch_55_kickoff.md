...
1. `branches/06_deep_verification/_progress.json` (recovery_hint + O-P1-185 LOW context)
...
4. `branches/06_deep_verification/multi_session/MULTI_SESSION_RETRO_ROUND_13.md` (D-MS-NEW-13-7 P0 baseline absence backfill decision)
5. `branches/06_deep_verification/evidence/checkpoints/P1_batch_52_report.md` §6 (round 13 batch 52 pre-flight discovery O-P1-185 LOW + recommendation)
