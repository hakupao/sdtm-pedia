...
1. `branches/06_deep_verification/_progress.json` (recovery_hint + round 11 cumulative state)
2. `branches/06_deep_verification/subagent_prompts/P0_writer_pdf_v1.7.md` (176 lines, v1.7 N21 + Hook 16.7)
3. `branches/06_deep_verification/subagent_prompts/P0_reviewer_v1.7.md` (137 lines, Rule D 59 → 62 expected post round 12)
4. `branches/06_deep_verification/multi_session/MULTI_SESSION_PROTOCOL.md` (master)
5. `branches/06_deep_verification/multi_session/MULTI_SESSION_RETRO_ROUND_11.md` (round 11 retro for context — D-MS-NEW-11-1 drift cal motif type taxonomy + G-MS-NEW-11-1 H_A vs H_B hypothesis discrimination + R-MS-15 single-agent family 2-burn pattern)
