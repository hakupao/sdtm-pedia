...
1. `branches/06_deep_verification/_progress.json` — recovery_hint 完整 round 4 narrative ~14500 chars (current state authoritative source post round 4)
2. `branches/06_deep_verification/multi_session/MULTI_SESSION_RETRO_ROUND_4.md` — 12 R-MS retain + 6 G-MS gap + 7 D-MS decision (Rule C 三段式 26180 bytes)
3. `branches/06_deep_verification/multi_session/MULTI_SESSION_RETRO_ROUND_3.md` — NEW7 L7 + G-MS-11.b + G-MS-13 NEW gap origin
4. `branches/06_deep_verification/multi_session/MULTI_SESSION_RETRO_ROUND_2.md` — G-MS-11 NEW6 dual-form 起源 + G-MS-12 density alarm 起源
5. `branches/06_deep_verification/subagent_prompts/v1.3_patch_candidates.md` — 188 行 base candidates (round 1-2 NEW1-NEW5 spec) + round 3 NEW7-NEW8 + round 4 NEW8.b/c/G-MS-12.a 加 (本 session 必须完整吸收)
6. `branches/06_deep_verification/subagent_prompts/P0_writer_pdf_v1.2.md` — writer base
7. `branches/06_deep_verification/subagent_prompts/P0_writer_md_v1.2.md` — md writer base
8. `branches/06_deep_verification/subagent_prompts/P0_matcher_v1.2.md` — matcher base
9. `branches/06_deep_verification/subagent_prompts/P0_reviewer_v1.2.md` — reviewer base
10. `branches/06_deep_verification/schema/atom_schema.json` + `ledger_schema.json` — v1.2 schema, frozen carry-forward (v1.3 link 不改)

**附读** (verify-only, 验 round 4 reconciler-side fix evidence):
- `branches/06_deep_verification/multi_session/sibling_continuity_sweep_report_round4.md` — round 4 reconciler safety net 4-atom Option H NEW7 L6 LB-Examples drift O-P1-79 detail
- `branches/06_deep_verification/evidence/checkpoints/_progress_batch_25.json` — round 4 batch 25 terminal sib state for sub-batch handoff template reference

═══════════════════════════════════════════════════════════════════
## STEP 1 — Writer Pass: 写 v1.3 4 个 Prompts (主 session writer 角色)
═══════════════════════════════════════════════════════════════════

### 产出文件 (路径: `branches/06_deep_verification/subagent_prompts/`)
...
Inputs to read:
1. branches/06_deep_verification/subagent_prompts/P0_writer_pdf_v1.3.md (NEW main writer)
2. branches/06_deep_verification/subagent_prompts/P0_writer_md_v1.3.md
3. branches/06_deep_verification/subagent_prompts/P0_matcher_v1.3.md
4. branches/06_deep_verification/subagent_prompts/P0_reviewer_v1.3.md
5. branches/06_deep_verification/multi_session/MULTI_SESSION_RETRO_ROUND_4.md (12 R-MS + 6 G-MS + 7 D-MS)
6. branches/06_deep_verification/subagent_prompts/v1_3_cut_kickoff.md §STEP 1 codification list A-M
7. branches/06_deep_verification/subagent_prompts/P0_writer_pdf_v1.2.md (v1.2 base for diff)
...
DATE=$(date +%Y-%m-%d)
mkdir -p "branches/06_deep_verification/subagent_prompts/archive/v1.2_final_${DATE}"
cp branches/06_deep_verification/subagent_prompts/P0_writer_pdf_v1.2.md "branches/06_deep_verification/subagent_prompts/archive/v1.2_final_${DATE}/"
cp branches/06_deep_verification/subagent_prompts/P0_writer_md_v1.2.md "branches/06_deep_verification/subagent_prompts/archive/v1.2_final_${DATE}/"
cp branches/06_deep_verification/subagent_prompts/P0_matcher_v1.2.md "branches/06_deep_verification/subagent_prompts/archive/v1.2_final_${DATE}/"
cp branches/06_deep_verification/subagent_prompts/P0_reviewer_v1.2.md "branches/06_deep_verification/subagent_prompts/archive/v1.2_final_${DATE}/"
```
...
### Edit `branches/06_deep_verification/multi_session/batch_26_kickoff.md`
...
### Edit `branches/06_deep_verification/multi_session/MULTI_SESSION_PROTOCOL.md`
...
1. **`branches/06_deep_verification/_progress.json`**:
...
2. **`branches/06_deep_verification/PLAN.md`** v0.5 → v0.6 (若引用 v1.2):
...
4. **`branches/06_deep_verification/subagent_prompts/v1.3_patch_candidates.md`**:
...
```bash
git add branches/06_deep_verification/subagent_prompts/ \
  branches/06_deep_verification/_progress.json \
  branches/06_deep_verification/PLAN.md \
  branches/06_deep_verification/multi_session/ \
  .work/MANIFEST.md \
