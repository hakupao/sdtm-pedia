# branches/jp_delivery/ 改訂履歴 (CHANGELOG)

> 本ファイルは `branches/jp_delivery/` 配下の全納品物 (.xlsx) + 内部文書 (PLAN / EXECUTION_PLAN) の改訂履歴を一元管理する.
...
- 産物: branches/jp_delivery/sources/01_要件定義書.yml (217 行) + branches/jp_delivery/01_要件定義書.xlsx (10 シート).
...
- 産物: branches/jp_delivery/sources/02_基本設計書.yml + branches/jp_delivery/02_基本設計書.xlsx (31,860 bytes / 10 シート / sha256 12721d04050f525014549eada7aef662edcbfd550acbfde7e4c4bc65ad8310cb).
...
- 産物: branches/jp_delivery/sources/00_納品範囲.yml + branches/jp_delivery/00_納品範囲.xlsx (19,399 bytes / 10 シート / sha256 a8552b2f1fba6afd062abe6506779e145dd64da059aaf4b5c6f0558ebc2b0063).
...
- 産物: branches/jp_delivery/sources/07_進捗報告書.yml + branches/jp_delivery/07_進捗報告書.xlsx (19,731 bytes / 9 シート / sha256 a96b8642af4c04eb0af3d9c5005d9c4821745b037ea243b5643bd5e4d8524be4).
- 作成: 主 session (executor + build_xlsx.py).
