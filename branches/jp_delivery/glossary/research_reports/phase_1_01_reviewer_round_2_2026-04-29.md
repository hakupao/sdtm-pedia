...
- 入力:
  - writer 産物 v0.2: branches/jp_delivery/sources/01_基本設計書.yml + branches/jp_delivery/01_基本設計書.xlsx (31,448 bytes / sha256 4b60edbf9e9da9df52d1e6b548630c29300cf3f22db7a9f16d44c20b31fba232)
  ...
  - 評価軸: branches/jp_delivery/PLAN.md §3 §6 §10
...
- observation:
  reviewer 環境で yml v0.2 を読込 → ファイル `branches/jp_delivery/01_基本設計書.xlsx` を確認したところ:
...
- evidence:
  ```
  $ ls -la branches/jp_delivery/01_基本設計書.xlsx
  -rw-r--r--@ 1 bojiangzhang staff 31448 Apr 29 21:02 branches/jp_delivery/01_基本設計書.xlsx
  $ shasum -a 256 branches/jp_delivery/01_基本設計書.xlsx
  4b60edbf9e9da9df52d1e6b548630c29300cf3f22db7a9f16d44c20b31fba232 ← kickoff 申告と一致
  $ python3 branches/jp_delivery/scripts/build_xlsx.py branches/jp_delivery/sources/01_基本設計書.yml
...
| **F-9 (I-01)** | yml §6 PMDA 行で正式名称に整合 | yml l.385: 「PMDA ER/ES 指針 (正式名: 「医薬品等の承認又は許可等に係る申請等における電磁的記録及び電子署名の利用について」)」明記。`branches/jp_delivery/PLAN.md` §11.3 l.456 (「医薬品等の承認又は許可等に係る申請等における電磁的記録及び電子署名の利用について」) と完全一致 | **PASS** |
...
-rw-r--r--@ 1 bojiangzhang staff 31448 Apr 29 21:02 branches/jp_delivery/01_基本設計書.xlsx
$ shasum -a 256 branches/jp_delivery/01_基本設計書.xlsx
4b60edbf9e9da9df52d1e6b548630c29300cf3f22db7a9f16d44c20b31fba232  branches/jp_delivery/01_基本設計書.xlsx
$ python3 branches/jp_delivery/scripts/build_xlsx.py branches/jp_delivery/sources/01_基本設計書.yml
生成完了: /Users/bojiangzhang/MyProject/SDTM-compare/branches/jp_delivery/01_基本設計書.xlsx
ファイルサイズ: 31,449 bytes
シート数: 10
...
```bash
$ grep -nE 'です。|です$|ですが|ですので|でした' branches/jp_delivery/sources/01_基本設計書.yml
(no output)
$ grep -nE 'ます。|ます$|ますが|ますので|ました' branches/jp_delivery/sources/01_基本設計書.yml
(no output)
```
...
```bash
$ grep -c "出典:" branches/jp_delivery/sources/01_基本設計書.yml
11
```
...
- v0.2 yml: `/Users/bojiangzhang/MyProject/SDTM-compare/branches/jp_delivery/sources/01_基本設計書.yml`
- v0.2 xlsx: `/Users/bojiangzhang/MyProject/SDTM-compare/branches/jp_delivery/01_基本設計書.xlsx` (31,448 bytes / sha256 4b60edbf… kickoff 申告値と一致)
- writer round 2 report: `/Users/bojiangzhang/MyProject/SDTM-compare/branches/jp_delivery/glossary/research_reports/phase_1_01_writer_round_2_2026-04-29.md`
- writer round 1 report: `/Users/bojiangzhang/MyProject/SDTM-compare/branches/jp_delivery/glossary/research_reports/phase_1_01_writer_2026-04-29.md`
- reviewer round 1 report: `/Users/bojiangzhang/MyProject/SDTM-compare/branches/jp_delivery/glossary/research_reports/phase_1_01_reviewer_round_1_2026-04-29.md`
- 用語監査 round 1 report: `/Users/bojiangzhang/MyProject/SDTM-compare/branches/jp_delivery/glossary/research_reports/phase_1_01_term_audit_2026-04-29.md`
- 引用源マッピング: `/Users/bojiangzhang/MyProject/SDTM-compare/branches/jp_delivery/glossary/research_reports/01_source_mapping_2026-04-29.md`
...
- PLAN.md: `/Users/bojiangzhang/MyProject/SDTM-compare/branches/jp_delivery/PLAN.md`
- style_guide.xlsx: `/Users/bojiangzhang/MyProject/SDTM-compare/branches/jp_delivery/templates/style_guide.xlsx`
