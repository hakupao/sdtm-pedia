...
> 上流仕様: `branches/jp_delivery/PLAN.md` §3 / §11.1, `branches/jp_delivery/EXECUTION_PLAN.md` §3 Phase 0.7
...
- 場所: `branches/jp_delivery/scripts/build_xlsx.py` `build()` 関数 (行 469-534)
...
- 場所: `branches/jp_delivery/scripts/build_xlsx.py` `_sheet_cover` / `_sheet_revision` / `_sheet_toc` / `_sheet_text` / `_sheet_table` / `_sheet_links` / `_sheet_approval` / `main`
...
- 場所: `branches/jp_delivery/scripts/generate_style_guide.py` 全 642 行
