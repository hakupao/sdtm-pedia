...
> 産物: `branches/jp_delivery/templates/cover_template.xlsx` / `branches/jp_delivery/scripts/generate_cover_template.py`
> 上流文書: `branches/jp_delivery/PLAN.md` §3.1 §3.2 §4 / `branches/jp_delivery/EXECUTION_PLAN.md` §3 Phase 0.7
