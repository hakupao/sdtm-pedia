...
| **Phase 6.5 Gemini v7 LIVE (post-apply smoke PASS 2026-04-24)** | **`ai_platforms/gemini_gems/current/system_prompt.md`** — v7 LIVE (applied to Gem UI 2026-04-24, 28,107 bytes), 基于 v6-post-A1 (18,716 chars); 2 patch: (1) CO-1c ARMCD null assignment rule (ARMCD/ARM null + ARMNRS C142179 Extensible 填全称, 禁 NOTASSGN / C66770 / 虚构 OBSERVATIONAL GROUP, R1+R2 Q13 (b) 系统性 gap 修) + (2) CO-4 §GF 正向清单双锚 (Core=Req/Exp 完整集 + 执行规则 3 条 + sanity 自检删重, R2 Q1 GFGENE regression HIGH 修); **post-apply smoke Q1 PASS + Q13 PASS 2026-04-24** (Q1 GFGENE regression 未复发; Q13 ARMCD null + 禁 NOTASSGN 生效; MINOR carry-over: Q13 ARMNRS 推荐值 "NOT APPLICABLE" 非 canonical C142179, non-blocking). Draft 原档 `gemini_gems/dev/v7_draft/system_prompt_v7.md` 保留作 provenance. 详见 `gemini_gems/dev/evidence/smoke_v4_answers/Q1_answer.md` + `Q13_answer.md` |
