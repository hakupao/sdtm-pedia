...
> 最后更新: 2026-05-06 (P2 B-03c round 08 CLOSED — ★ v1.9.2 2nd sustained round + §2.7 lock 2 cases PASS + §2.5 lock 10 cases PASS + 0 NEW lock 0 halt 0 post-hoc fix; v1.9.3 cut planning trigger MET stack 10)
...
| **06 旁枝** Deep Verification | 🟢 进行中 | P2 B-03c round 08 CLOSED 2026-05-06 (★ v1.9.2 2nd sustained round PASS + §2.7 lock 2 cases PASS + §2.5 lock 10 cases PASS; 10 batches 240 atoms 5 domains PE/PP/PR/QS/RE 0 halt 0 post-hoc fix 0 NEW lock — B-03c 1st grep-verified 0-trigger round; 39/63 domains 61.9% / 93/141 files 65.96% / B-03c 72/114 = 63.16%; v1.9.3 cut planning trigger MET stack 10 — cut deferred post round 09); round 09 pending Bojiang ack scope (default RELREC/RP/RS/SC/SE) | 详见 `.work/06_deep_verification/_progress.json` |
...
| 覆盖 domain 数 | 63 | 同上 |
| 06 累计 md_atoms | 8815 | `.work/06_deep_verification/_progress.json` `b_03c_round_08_details.cumulative_post_round_08.md_atoms_jsonl_total` |
| 06 P2 B-03c 进度 | 72/114 = 63.16% | 同上 `b_03c_progress_pct` |
| 06 P2 file coverage | 93/141 = 65.96% | 同上 `file_coverage_pct` |
| 06 P2 domain coverage | 39/63 = 61.9% | 同上 `domain_coverage_pct` |
