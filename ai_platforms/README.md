...
**Claude 终态关键产物** (reorg 后路径):
- [docs/PLAN_V2.md](claude_projects/docs/PLAN_V2.md) — 8 阶段 ~30 Tasks 完整计划
- [docs/RETROSPECTIVE_V2.md](claude_projects/docs/RETROSPECTIVE_V2.md) — 7 章复盘 (Rule C 产物)
- [docs/rag_decay_curve.md](claude_projects/docs/rag_decay_curve.md) — 7 数据点 RAG 质量 vs 规模曲线
- [docs/phase7_handoff.md](claude_projects/docs/phase7_handoff.md) — 6 actionable for Phase 7
- [current/](claude_projects/current/) — 当前可部署 v2.6 (19 上传文件)
...
├── claude_projects/                   v2.6 终态 (2026-04-20 reorg 后)
│   ├── README.md                       新结构入口
│   ├── ROADMAP.md                      总路线
│   ├── current/                        可部署 v2.6 (uploads/ 19 文件 + system_prompt + upload_manifest)
│   ├── docs/                           方法论 & 一等参考 (PLAN_V2 + RETROSPECTIVE_V2 + rag_decay_curve + phase7_handoff + capacity_research)
│   ├── dev/                            开发过程冷区 (scripts + evidence + ab_reports + checkpoints + test_results)
│   └── archive/                        历史归档 (RETROSPECTIVE.md 顶层 + v1/{docs,scripts,uploads})
└── gemini_gems/
    ├── ROADMAP.md                     行进路线
    └── output/
