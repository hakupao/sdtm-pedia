...
|------|---------|---------|---------|------|
| **Claude Projects** | 精确查询 + 规则推理 | 发布版 1.29M tokens / 19 文件 / capacity 77% | 自己日常使用 | **发布版完成** (2026-04-20) |
| **ChatGPT GPTs** | 全量覆盖 + 团队分享 | 合并文件全量上传 (~9.6MB) | 团队 + 外部 | 待开始 |
| **Gemini Gems** | 大范围探索 + 全域对比 | 核心全量 (~512K tokens) | 自己深度分析 | 待开始 |

**Claude 入口**:
- 🟢 用户/部署者 → [claude_projects/current/UPLOAD_TUTORIAL.md](claude_projects/current/UPLOAD_TUTORIAL.md) (完整部署教程)
- 🟡 方法论参考 → [claude_projects/docs/](claude_projects/docs/) (计划 / 复盘 / RAG 衰减数据 / Phase 7 交接)
- ⚫ 早期迭代归档 → [claude_projects/archive/](claude_projects/archive/)
