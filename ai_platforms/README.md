...
## ai_platforms/ 目录结构 (2026-04-24 整理后)
...
│
├── 4 平台/ (每个平台 current/docs/dev/archive 四层)
│   ├── claude_projects/              v2.6 终态完成
│   ├── chatgpt_gpt/                  v2.2 LIVE (2026-04-24, post smoke Q1 PASS)
│   ├── gemini_gems/                  v7.1 LIVE (2026-04-24 PM, post smoke Q10 PASS+)
│   └── notebooklm/                   P3.8 完成 (9/10)
│
├── retrospectives/                   跨阶段 Rule C 产物 (5 份)
│   ├── R1_RETROSPECTIVE.md               4 平台 smoke v4 R1 baseline 收尾 (2026-04-22 晚)
│   ├── R2_RETROSPECTIVE.md               Gemini R2 re-run 闭合 (2026-04-23 PM, 双硬 gate PASS)
│   ├── PHASE5_RETROSPECTIVE.md           跨 4 平台 Phase 5 retro (2026-04-23 PM, ack-ready)
│   ├── PHASE5_28TH_REVIEWER.md           Phase 5 28th Rule D reviewer (critic CONDITIONAL_PASS 82)
│   └── V5C_REGRESSION_REVIEWER.md        V5C regression 15th Rule D reviewer (APPROVE)
│
├── plans/                            跨平台 plan (1 份)
│   └── V5C_REGRESSION_PLAN.md            V5C Q4-Q10 双平台 regression plan (ChatGPT+Gemini)
│
└── archive/                          历史归档
    ├── smoke_history/                    smoke v1-v3 历史 (5 份 SUPERSEDED / work-done)
    ...
    │   ├── smoke_v3_audit_notes.md           第 11 种 subagent audit 证据
    │   └── PHASE4_PLAN.md                    Phase 4 原 plan (被 SMOKE_V4.md §1 取代)
    └── handoffs/                         phase-level session handoff 归档 (3 份过期)
        ├── NEXT_STEPS.md                     2026-04-22 R1 session 下一步清单
        ├── R1_SESSION_HANDOFF.md             2026-04-22 晚 R1 onboard handoff
        └── SMOKE_V4_R1_RESUME_HANDOFF.md     2026-04-22 夜 Q10 后 resume handoff
```

**每平台 `dev/archive/drafts/`** 归档各自 system prompt 历史草稿 (ChatGPT v2.2 / Gemini v6/v7/v7.1), 作 provenance.
