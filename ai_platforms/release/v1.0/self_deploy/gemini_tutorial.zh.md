...
- [ ] **本地 clone 本仓库**: 需要读 `../../gemini_gems/current/` 下 `system_prompt.md` (约 29.9KB) 和 `uploads/` 下 4 个 .md 文件
...
2. **完整复制** `../../gemini_gems/current/system_prompt.md` (v7.1 LIVE, 29,919 chars) 粘贴
...
2. 选 `../../gemini_gems/current/uploads/` 下**全部 4 个 .md 文件**, 顺序:
