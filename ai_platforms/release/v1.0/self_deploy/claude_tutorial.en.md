...
- [ ] **Local clone of this repository**: you will need the 19 files under `../../claude_projects/current/uploads/` and `../../claude_projects/current/system_prompt.md`
...
3. **Copy the entire contents** of `../../claude_projects/current/system_prompt.md` (do not truncate)
...
2. Select **all 19 `.md` files** in the `../../claude_projects/current/uploads/` directory at once
...
Order does not matter; upload all of them. The full list is in `../../claude_projects/current/README.md` §Upload Manifest.
