...
- [ ] **Local clone of this repository**: you need to read `system_prompt.md` (~29.9 KB) and the 4 `.md` files under `uploads/` from `../../gemini_gems/current/`
...
2. **Copy the entire contents** of `../../gemini_gems/current/system_prompt.md` (v7.1 LIVE, 29,919 chars) and paste it in
...
2. Select **all 4 `.md` files** under `../../gemini_gems/current/uploads/`, in this order:
