<!-- generated by scripts_v2/rebuild_chapters_full.py at 2026-04-18T13:32:01Z -->

# SDTMIG v3.4 - Chapters (v2 Full)

This file is the v2 full-expansion of the SDTMIG v3.4 chapters. It reverses the v1 compression (which dropped prose/examples/legalese and kept only Spec tables plus numbering rules); every chapter below is the unmodified source from `knowledge_base/chapters/`.
