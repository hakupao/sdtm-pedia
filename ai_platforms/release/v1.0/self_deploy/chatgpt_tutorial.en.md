...
- [ ] **Local clone of this repository**: you need to read `../../chatgpt_gpt/current/system_prompt.md` (~8.6 KB) and the 9 .md files under `../../chatgpt_gpt/current/uploads/`
...
2. **Copy the full contents** of `../../chatgpt_gpt/current/system_prompt.md` (v2.2 LIVE, 8,582 chars) and paste them in
...
2. Select **all 9 .md files** under `../../chatgpt_gpt/current/uploads/`, in order: `01 → 02 → 03 → 04 → 05 → 06 → 07 → 08 → 09`
