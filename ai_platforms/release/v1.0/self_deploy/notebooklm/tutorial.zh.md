...
5. **分享档位** (默认 Restricted, 稍后 §7 详解 2 档切换): 起步保持 Restricted, smoke test 通过再按场景切
...
*v1.1 — 2026-05-11 — UI 术语同步至 2026 年官方规范 (Create new notebook / Add 按钮 / Configure Chat / 分享 2 档 / Studio 4 块瓷砖)*
