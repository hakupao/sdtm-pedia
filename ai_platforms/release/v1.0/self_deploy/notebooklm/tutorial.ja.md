...
5. **共有レベル** (デフォルトは Restricted。§7 で 2 段階切替を詳しく説明します): まず Restricted のまま開始し、smoke test 通過後に用途に応じて切り替えてください
...
*v1.1 — 2026-05-11 — UI 用語を 2026 年公式仕様に同期 (Create new notebook / Add ボタン / Configure Chat / 共有 2 段階 / Studio 4 タイル)*
