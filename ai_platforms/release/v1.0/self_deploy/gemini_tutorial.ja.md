...
> このチュートリアルを読み終えると、SDTM 変数定義 / ビジネスシナリオマッピング / クロスドメイン関連付けに精確に回答でき、よくある虚構の前提を見破る (AHP × 3 アンチハルシネーションガード) Gemini Gem が完成します。
...
`../DEMO_QUESTIONS.md` を開き、Q1〜Q10 を順に質問します。**1 問につき新しいチャット**を使用してください。R2 ベースライン 16/17 (94.1%)、AHP × 3 全 PASS+。デプロイした Gem が ≥ 8/10 strict であればベースライン相当です。
