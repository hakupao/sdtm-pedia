# 25_td_meta_ti_ts_oi_di

> **NotebookLM Source Metadata** (由 merge_sources.py 生成, 供 NotebookLM 索引 + citation 反查)
>
> - **Bucket ID**: `25`
> - **Concept**: Trial Design + Study Reference: TI + TS + OI + DI (inclusion + summary + organism + device identifiers; DI added 06 P6 T4 2026-05-12; renamed v1.3 B5/M3 to include _di slug)
> - **Merged files**: 10
> - **Words**: 8,716
> - **Chars**: 48,958
> - **Sources**:
...
## Source: `domains/DI/assumptions.md`
